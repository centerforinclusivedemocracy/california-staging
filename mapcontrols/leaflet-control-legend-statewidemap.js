...
L.Control.StatewideMapLegend = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.container.innerHTML += '<div class="legend-entry"><span class="legend-swatch legend-swatch-fullmodelCID"></span> Suggested Voting Locations </div>';
        this.container.innerHTML += '<div class="legend-entry"><span class="legend-swatch legend-swatch-fullmodelGIN"></span> Suggested Vote Center Locations</div>';
